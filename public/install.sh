#!/bin/sh
set -eu
api="https://api.github.com/repos/B-Divyesh/sf-diagram-source-studio/releases/latest"
...
expected="$(awk -v file="$asset_name" '$2 == file || $2 == "./" file { print $1 }' "$temp_dir/SHA256SUMS")"
