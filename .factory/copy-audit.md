...
Read-aloud result: the headline, audience sentence, action, and result fit in one breath and name the job directly.
...
| Copy | Words |
| --- | ---: |
| Privacy and product limits | 4 |
| No sign-in is required to use the editor. | 8 |
| Diagram source stays on your device. | 6 |
